...
###############################################################################
			...
			#Mount
				sudo mount -t udf -o rw "/dev/$DEVICE_TO_CONFIGURE"1 /home/pinodedoge/.dogecoin
